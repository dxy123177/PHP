                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3><a href="../sessions/index.php">登录</a> / 注册</h3>
                            		<p>请写下你的用户名和密码:</p>
                        		</div>
                            </div>
                            <div class="form-bottom">
			                    <form action="save.php" role="form" action="" method="post" class="login-form">
                                    ...
                                    <div class="form-group">
                                        <label class="sr-only" for="form-password">确定密码</label>
                                        <input type="password" name="password2" placeholder="密码..." class="form-password form-control" id="form-password">
                                    </div>
